<?php
    function ajouterModifierAnnoce($t1='',$t2='',$t3='',$t4='',$t5='',$t6='',$t7='',$t8='',$t9='',$t10='',$t11='',$t12='',$t13='',$t14='',$t15='',$t16='',$t17='',$t18=''){
        ?>
           <div>
                    ...
                    <div class="plus-images">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <label for="imageA2">
                                        <img  id="imgload2" <?php if($t14!='')echo "src=".$t14;?> alt="" width="237px"   style="position: absolute; top: 57px; left:2px; ">
                                    ...
                                    <label for="imageA3">
                                        <img  id="imgload3" <?php if($t15!='')echo "src=".$t15;?> alt="" width="237px"  style="position: absolute; top: 57px; left:243px; ">
                                    ...
                                    <label for="imageA4">
                                        <img  id="imgload4" <?php if($t16!='')echo "src=".$t16;?> alt="" width="237px"  style="position: absolute; top: 57px; left:484px; ">
                                    ...
                                    <label for="imageA5">
                                    <img  id="imgload5" <?php if($t17!='')echo "src=".$t17;?> alt="" width="237px"  style="position: absolute; top: 57px; left:725px; ">
