        ...
        <div class="AnnonceComplet">
                    ...
                    <div class="local-type-annoce">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                &nbsp&nbsp<span  class="titre-m3lomat">Université la plus proche: </span><span class="m3lomat"><?php echo "ecole supérieure de technonlogie ourzazat"."&nbsp&nbsp&nbsp&nbsp"?></span>&nbsp&nbsp
                                </td>
            ...
            <div class="information-propriéitaire">
                <table>
                    ...
                    <tr>
                        <td><?php echo" oussma ourzazi";?></td>
                    </tr>
                    <tr>
                        <td><span class="titre-m3lomat">Ville</span></td>
                    </tr>
                    <tr>
                        <td><?php echo"ourzazat";?></td>
                    </tr>
                    <tr>
                        <td><span class="titre-m3lomat">Gmail</span></td>
                    </tr>
                    <tr>
                        <td><?php echo"badou.ourzazi20@ump.ac.ma"?></td>
                    </tr>
                    <tr>
