...
<html>
    ...
    <body>
        ...
        <header class="head">
         ...
         <a href="#"><img src="../photo_files/home.png" ></a>
            ...
            <nav>
                <ul class="headLinks">
                    ...
                    ?>
                        ...
                        <a href="pagePropriétaire.php"><li ><button class="buttonDéposition">Déposer une offre </button></li></a>
                    <?php
                    ...
                    <?php
                     ...
                     ?>
                     <!-- PAGE DE CRIER -->
                        <li ><button class="buttonDéposition" onclick="afficherPage1()">Déposer une offre</button></li>
                        
                    <?php   }?>
                    <!-- changer de nom de les autelasteur  -->
                    <span class="id" >
